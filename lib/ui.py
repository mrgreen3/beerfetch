...
_ICON_CPU = """<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#8c8070"
     stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
  <rect x="7" y="7" width="10" height="10" rx="1"/>
  <path d="M10 2v3M14 2v3M10 19v3M14 19v3M2 10h3M2 14h3M19 10h3M19 14h3"/>
</svg>"""

_ICON_MEM = """<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#8c8070"
     stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
...
_ICON_DISK = """<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#8c8070"
     stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
...
_ICON_FW = """<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#8c8070"
  ...
  <circle cx="8.5" cy="8.5" r="1" fill="#8c8070" stroke="none"/>
...
h2 { color: #c9b890; margin-bottom: 12px; }
button {
  background: #c9b890;
  color: #201b14;
  border: none;
...
button:hover { background: #ddd0a8; }
...
.val { margin: 0 0 4px; }
.rule { border: none; border-top: 1px solid #3a3228; margin: 16px 0 12px; }
.muted { color: #8c8070; }
...
<div class="logo">
  <svg xmlns="http://www.w3.org/2000/svg" width="300" height="120" viewBox="0 0 300 120">
    ...
    <text x="150" y="98" text-anchor="middle" font-family="monospace" font-size="15"
          fill="#c9c0b0" letter-spacing="5">beerfetch</text>
  </svg>
</div>
